-- AscenD Finance Database Schema - MVP Version
...
-- INSERT INTO expense_categories (name, display_name, description, sort_order) VALUES
-- ('necessity', 'Necessity', 'Essential expenses like food, rent, transport', 1),
-- ('investment', 'Investment', 'Expenses that bring value or improve life/profession', 2),
-- ('status', 'Status', 'Expenses for luxury, image, or indulgence', 3),
-- ('savings', 'Savings', 'Money set aside for future use', 4);
...
-- -- ✅ 7 Core Tables (vs 21 in complex version):
-- --   1. users - Authentication and basic info
-- --   2. user_preferences - Settings and preferences
-- --   3. expense_categories - The 4 core categories + user custom (frontend handles colors/icons)
...
-- --   - Only essential indexes (12 vs 50+)
...
-- -- Version: 1.0 (MVP - Streamlined)
-- -- Ready for backend development with minimal complexity

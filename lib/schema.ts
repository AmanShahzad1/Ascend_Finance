...
// Create all tables based on our MVP schema
export const createTables = async (): Promise<void> => {
  try {
    ...
    await query(`
      ...
      CREATE INDEX IF NOT EXISTS idx_expense_categories_system ON expense_categories(user_id) WHERE user_id IS NULL;
      CREATE INDEX IF NOT EXISTS idx_daily_messages_active ON daily_messages(is_active);
      CREATE INDEX IF NOT EXISTS idx_user_message_history_user_date ON user_message_history(user_id, shown_date);
    `);
